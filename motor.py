...
class DCMotor:
    ...
    def set_encoder(self, rpm, ppr, gears):
        ...
        self.ticks_per_rev = ppr * 4 * gears # encoder ticks count per revolution (driver decodes X4)
    ...
    def speed(self):
        ...
        return round(self.driver.get_speed(self.port)*60/self.ticks_per_rev*self._reversed, 1)
